...
export const PAY_TIERS: PayTier[] = [
  ...
  { symbol: SlotSymbol.bar, count: 5, label: "5 × Bar", prize: "2.25 ICP" },
  { symbol: SlotSymbol.bar, count: 4, label: "4 × Bar", prize: "1.80 ICP" },
  { symbol: SlotSymbol.bar, count: 3, label: "3 × Bar", prize: "1.35 ICP" },
  { symbol: SlotSymbol.seven, count: 5, label: "5 × Seven", prize: "1.15 ICP" },
  { symbol: SlotSymbol.seven, count: 4, label: "4 × Seven", prize: "0.92 ICP" },
  { symbol: SlotSymbol.seven, count: 3, label: "3 × Seven", prize: "0.69 ICP" },
  ...
  { symbol: SlotSymbol.star, count: 5, label: "5 × Star", prize: "0.90 ICP" },
  { symbol: SlotSymbol.star, count: 4, label: "4 × Star", prize: "0.72 ICP" },
  { symbol: SlotSymbol.star, count: 3, label: "3 × Star", prize: "0.54 ICP" },
  {
